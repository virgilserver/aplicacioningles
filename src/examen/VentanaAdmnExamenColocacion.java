 ...
 * @author Luis
 */
public class VentanaAdmnExamenColocacion extends javax.swing.JFrame {
    ...
    public VentanaAdmnExamenColocacion(int id, String nombre, String fecha, String hora, String salon) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ConexionSQLServer.asignarAlumnoExamenColocacion(idA, idExamen);
         llenarTablaAsignados();
        llenarTablaNoAsignados();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ConexionSQLServer.desasignarAlumnoExamenColocacion(ida,idExamen);
            llenarTablaAsignados();
        llenarTablaNoAsignados(); 
    ...
    private void llenarTablaAsignados() {
        ...
        String query = "Select numeroDeControl AS [No. Control],RTRIM(nombreAlumno) +' '+ RTRIM(apellidoAlumno) as Nombre  from ExamenColocacion INNER JOIN Alumno_has_ExamenColocacion "
   ...
   tablaAlumnosAsignados.getColumnModel().getColumn(0).setPreferredWidth(85);
    ...
    private void llenarTreemapAsignados() {
        try {
            ...
            ResultSet rs = ConexionSQLServer.vistaAlumnosAsigandosAExamenColocacion(idExamen);
            while (rs.next()) {
