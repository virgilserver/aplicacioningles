 ...
 * @author Luis
 */
public class VentanaAdmnExamenLiberacion extends javax.swing.JFrame {
    ...
    public VentanaAdmnExamenLiberacion(int id, String nombre, String fecha, String hora, String salon) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ConexionSQLServer.asignarAlumnoExamenLiberacion(idA, idExamen);
         llenarTablaAsignados();
        llenarTablaNoAsignados();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ConexionSQLServer.desasignarAlumnoExamenLiberacion(ida, idExamen);
            llenarTablaAsignados();
        llenarTablaNoAsignados(); 
           TFBuscar.setText("");
   ...
   tablaAlumnosAsignados.getColumnModel().getColumn(0).setPreferredWidth(85);
    ...
    private void llenarTreemapAsignados() {
        try {
            ...
            ResultSet rs = ConexionSQLServer.vistaAlumnosAsigandosAExamenLiberacion(idExamen);
            while (rs.next()) {
                ...
                idAlumnosAsignados.put(nc, id);
                       ...
                       System.out.println("cantidad lberados  +"+ idAlumnosAsignados.size());
        } catch (SQLException ex) {
            Logger.getLogger(VentanaAdmnExamenLiberacion.class.getName()).log(Level.SEVERE, null, ex);
        }
